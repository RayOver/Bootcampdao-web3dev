...
const App = () => {
  //Usando o hook connectWallet que o thirdweb nos dá
  const address = useAddress();
  const network = useNetwork();
  const connectWithMetamask = useMetamask();
  console.log("👋 Address:", address);
  // inicializar o contrato editionDrop
  const editionDrop = useEditionDrop("0x780785ff700F61585257ae616D0b1224DB02cF90");
  // inicializar o contrato de tokens
  const token = useToken("0x8C16dE536412B14B7CaA9377bc018A7aD6Be4DA8");
  // inicializar contrato de governança
  const vote = useVote("0x0C2eBCF1DE36947A62cedeE16c593Bed928CDCAc");
  ...
  //Quando usuário ainda não esta conectado ao webapp. Ele irá chamar connectWallet
  if(!address) {
    return (
      <div className="landing">
        <h1>Bem-vind@s à GamerShareDAO</h1>
  ...
  if (hasClaimedNFT) {
    return (
      <div className="member-page">
        <h1> Página de membros da GamerShareDAO </h1>
        <p>Você é parte da GamerShare!</p>
        <div>
          <div>
  ...
  //Quando já temos o endereço do usuário, renderiza a tela de cunhagem do NFT
  return (
    <div className="mint-nft">
      <h1>Cunhe gratuitamente seu NFT de membro GamerShareDAO</h1>
      <button
        disabled={isClaiming}
        onClick={mintNft}
      >
